...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring(
        ...
        # INCLUDED IN TKLAYOUT XML BUT ARE NOT DIFFERENT FROM THESE FILES
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTrackerMTD/pixfwd.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTrackerMTD/pixbar.xml',
        # 
        'Geometry/TrackerCommonData/data/trackermaterial.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTrackerMTD/tracker.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTrackerMTD/pixel.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTrackerMTD/pixbar.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTrackerMTD/pixfwd.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTrackerMTD/trackerbar.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTrackerMTD/trackerfwd.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTrackerMTD/trackerStructureTopology.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTrackerMTD/pixelStructureTopology.xml',
        'Geometry/TrackerSimData/data/PhaseII/TiltedTrackerMTD/trackersens.xml',
        'Geometry/TrackerSimData/data/PhaseII/TiltedTrackerMTD/pixelsens.xml',
        'Geometry/TrackerRecoData/data/PhaseII/TiltedTrackerMTD/trackerRecoMaterial.xml',
        'Geometry/TrackerSimData/data/PhaseII/TiltedTrackerMTD/trackerProdCuts.xml',
        'Geometry/TrackerSimData/data/PhaseII/TiltedTrackerMTD/pixelProdCuts.xml',
        'Geometry/TrackerSimData/data/trackerProdCutsBEAM.xml',
        ##### ALTERATIONS
        # 'Geometry/MTDCommonData/data/btl.xml',
        # 'Geometry/MTDCommonData/data/etl.xml',
        # 'Geometry/MTDCommonData/data/mtd.xml',
        # 'Geometry/MTDCommonData/data/mtdStructureTopology.xml',
        # 'Geometry/MTDSimData/data/mtdsens.xml',
        # 'Geometry/MTDSimData/data/mtdProdCuts.xml',
        'Geometry/MTDCommonData/data/alt/btl.xml',
        'Geometry/MTDCommonData/data/alt/etl.xml',
        'Geometry/MTDCommonData/data/alt/mtd.xml',
        'Geometry/MTDCommonData/data/alt/mtdStructureTopology.xml',
        'Geometry/MTDSimData/data/alt/mtdsens.xml',
        'Geometry/MTDSimData/data/alt/mtdProdCuts.xml',
        #######
